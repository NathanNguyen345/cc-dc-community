        ...
        <div className={styles.splashSectionFlex}>
          ...
          <div className={styles.desc}>
            <p>
              ...
              cutting-edge Tools to propel your success and unlock new horizons
              of achievement.
            </p>
          </div>
        ...
        <div className={styles.aboutSectionFlex}>
          ...
          <div className={styles.aboutDesc}>
            <p>
              ...
              transform document management and streamline workflows to empower
              your productivity. Please note that the the Document Cloud
              developer community maintains this repository.
            </p>
          </div>
        </div>
